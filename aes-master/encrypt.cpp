...
int main() {
	...
	cout << "=============================" << endl;
	cout << " 256-bit AES Encryption Tool   " << endl;
	cout << "=============================" << endl;
	...
	unsigned char expandedKey[240]; //60 words or permutations

	KeyExpansion(key, expandedKey);

	for (int i = 0; i < paddedMessageLen; i += 32) {
